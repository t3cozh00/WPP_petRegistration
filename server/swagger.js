...
const options = {
  ...
  apis: ["./api-docs/petRegistration.yaml", "./api-docs/petCategory.yaml"], // Path to your routes files
};
...
const swaggerDocs = (app) => {
  app.use(
    "/api-docs",
    swaggerUi.serve,
    swaggerUi.setup(specs, { explorer: true, withCredentials: false })
  );
  ...
  console.log(
    `API documentation is available at ${process.env.SERVER}:${process.env.PORT}/api-docs`
  );
};
